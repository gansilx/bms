...
class Book(models.Model):
    ...
    ISBN = models.CharField('编号', max_length=64,null=True)
    translator = models.CharField('译者', max_length=64,null=True)
    date = models.DateField('出版日期', max_length=64,blank=True,null=True)
